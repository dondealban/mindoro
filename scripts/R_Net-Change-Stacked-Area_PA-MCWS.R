...
# vegetation, and water. The plot shows net change for Mt Calavite Wildlife Sanctuary.
#
...
setwd("/Users/dondealban/Mindoro/pa_mcws")
...
ggsave(plot, file="StackedArea-00-Mindoro-PA-MCWS.pdf", width=16, height=15, units="cm", dpi=300)
