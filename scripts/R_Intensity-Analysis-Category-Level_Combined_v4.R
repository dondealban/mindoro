# Script Description --------------------
# This R script generates barplots using ggplot2 package to visualise the category-level intensity analysis of changes
# in Mindoro Island, Philippines derived from land cover classification of Landsat data for three time-intervals: 
# 1988-2000, 2000-2010, and 2010-2015. Intensity analysis was calculated using an Excel spreadsheet with a VBA macro
